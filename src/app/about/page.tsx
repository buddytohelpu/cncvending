          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">
                Built on <span className="text-emerald-600">Relationships</span>
                , Not Transactions
              </h2>
            ...
            <div className="bg-slate-50 rounded-2xl p-10">
              <div className="grid grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600 mt-2">States Served</p>
                </div>
                <div className="text-center">
                  <p className="text-4xl lg:text-5xl font-bold text-emerald-600">
                    24hr
                  </p>
                  <p className="text-slate-600 mt-2">Response Time</p>
                </div>
                <div className="text-center">
                  <p className="text-4xl lg:text-5xl font-bold text-emerald-600">
                    100%
                  </p>
                  <p className="text-slate-600 mt-2">Family-Owned</p>
                </div>
                <div className="text-center">
                  <p className="text-4xl lg:text-5xl font-bold text-emerald-600">
                    $0
                  </p>
                  <p className="text-slate-600 mt-2">Cost to You*</p>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {siteConfig.location.states.map((state) => (
              <span
                key={state}
                className="px-4 py-2 bg-slate-100 rounded-full text-slate-700 font-medium text-sm"
              >
                {state}
              </span>
            ))}

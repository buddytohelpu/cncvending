  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24 lg:h-28">
            ...
            <Link href="/" className="flex items-center space-x-3">
              <Image
                src="/images/logo.png"
                alt="CNC Vending - Modern Vending Solutions for New England"
                width={80}
                height={80}
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 right-6 z-40 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-3 rounded-full shadow-lg shadow-emerald-500/30 font-semibold text-sm flex items-center space-x-2 hover:shadow-xl transition-all duration-200"
      >
        <span>Get Quote</span>
      </button>
    </>
